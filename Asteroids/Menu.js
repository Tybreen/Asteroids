...
function GameOverMenu() {
  ...
  for(var i = 0; i < TimesList.length; i++) {
    ...
    fill(150, 0, 0);
    text(TimesList[i][0] + ", " + TimeConverter(TimesList[i][1]), CanvasWidth / 2, 270 + i * 50);
  }
  ...
  for(i = 0; i < 5; i++) {
    ...
    text(i + 1 + ".", (CanvasWidth / 2) - 95, 270 + i * 50);
    
    strokeWeight(2);
    stroke(150, 0, 0);
    
    line((CanvasWidth / 2) - 110, 275 + i * 50, (CanvasWidth / 2) + 110, 275 + i * 50);
