function preload() {
  ...
  //EngineSound.src = "Mp3/SpaceShip_Engine_Large_Loop_00.mp3";
...
var TimeMin1 = 0;
var TimeMin2 = 0;
var EngineSound = new Audio("Mp3/SpaceShip_Engine_Large_Loop_00.mp3");
var LazerSound = new Audio("Mp3/Laser/Laser_09.mp3");
...
function PlayerMovement() {
  ...
  if(Player.position.x >= CanvasWidth - 25) {
    Player.addSpeed(Player.getSpeed(), 180);
  }
  
  if(Player.position.x <= 25) {
    Player.addSpeed(Player.getSpeed(), 0);
  }
  
  if(Player.position.y >= CanvasHeight - 25) {
    Player.addSpeed(Player.getSpeed(), 270);
  }
  
  if(Player.position.y <= 25) {
    Player.addSpeed(Player.getSpeed(), 90);
  }
