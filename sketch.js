...
function PlayerLazers() {
  ...
  if(keyIsDown(32) && TimeSinceFired >= RateOfFire) {
    ...
    else CurrentLazer.shapeColor = color(Red, Green, Blue);
...
function HudDisplay() {
  ...
  if(SamMode) {
    ...
    if(Blue == 0 && Red == 255) Green += 51;
    if(Blue == 0 && Green == 255) Red -= 51;
    if(Red == 0 && Green == 255) Blue += 51;
    if(Red == 0 && Blue == 255) Green -= 51;
    if(Green == 0 && Blue == 255) Red += 51;
    if(Green == 0 && Red == 255) Blue -= 51;
  ...
  fill(0, 0, 150);
  if(SamMode) fill(Red, Green, Blue);
